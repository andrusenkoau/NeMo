...
__all__ = ['ConformerSqueeze']


class ConformerSqueezeEncoder(NeuralModule, Exportable, AccessMixin):
    """
    ...
    def forward_for_export(self, audio_signal, length):
        ...
        for lth, layer in enumerate(self.layers):
            # logging.warning(f"[DUBAG]: **********************")
            # logging.warning(f"[DUBAG]: layer number is: {lth}")
            ...
            # logging.warning(f"[DUBAG]: audio_signal.shape is: {audio_signal.shape}")
            # logging.warning(f"[DUBAG]: att_mask.shape is: {att_mask.shape}")
            # logging.warning(f"[DUBAG]: pos_emb.shape is: {pos_emb.shape}")
