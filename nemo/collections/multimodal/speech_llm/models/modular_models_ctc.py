...
class ModularAudioGPTModel(SpeechLLMAdapterMixin, MegatronGPTSFTModel):
    ...
    def prepare_llm_input(self, audio_batch):
        ...
        # [b, t, c]
        encoded, encoded_len, ctc_head_output = self.perception(
        ...
        return encoder_input, attention_mask, labels, loss_mask, encoder_length, ctc_head_output
    ...
    def forward(
        ...
        encoder_input, attention_mask, labels, loss_mask, _, ctc_head_output = self.prepare_llm_input(audio_batch)
        if self.mcore_gpt:
            output = self.model(
                input_ids=None,
                position_ids=None,
        ...
        return output, loss_mask, ctc_head_output
    ...
    def get_forward_output_only_func(self):
        def fwd_output_only_func(dataloader_iter, model):
            ...
            # model returns stndard output and ctc head logits
            output_tensor, _ = model(
                input_ids=None,
                position_ids=None,
